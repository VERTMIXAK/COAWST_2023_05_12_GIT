...
[~,dum] = unix('ls ../netcdfOutput/ | tail -1 | cut -d "_" -f1');model.file_prefix = [dum(1:end-1),'_']
model.file_suffix = '';
...
if ~exist( ['./',model.file_prefix,'his2',model.file_suffix,'_zeta.nc'])
    disp(['!ncrcat -v zeta -O ','../netcdfOutput/',model.file_prefix,'his2_*.nc ','./',model.file_prefix,'his2',model.file_suffix,'_zeta.nc'])
    eval(['!ncrcat -v zeta -O ','../netcdfOutput/',model.file_prefix,'his2_*.nc ','./',model.file_prefix,'his2',model.file_suffix,'_zeta.nc'])
%     eval(['!ncrcat -v zeta -d ocean_time,0 -O ','../netcdfOutput/',model.file_prefix,'his_*001.nc ','./',model.file_prefix,'his',model.file_suffix,'_zeta.nc'])
    ...
    eval(['!ncrcat -v ubar -O ','../netcdfOutput/',model.file_prefix,'his2_*.nc ','./',model.file_prefix,'his2',model.file_suffix,'_ubar.nc'])
%     eval(['!ncrcat -v ubar -d ocean_time,0 -O ','../netcdfOutput/',model.file_prefix,'his_*001.nc ','./',model.file_prefix,'his',model.file_suffix,'_ubar.nc'])
    ...
    eval(['!ncrcat -v vbar                 -O ','../netcdfOutput/',model.file_prefix,'his2_*.nc ','./',model.file_prefix,'his2',model.file_suffix,'_vbar.nc'])
...
%     tpxo.pha_vbar_BB = interp2(tpxo.lon(tpxo.idxs),tpxo.lat(tpxo.jdxs),tpxo.pha_vbar(tpxo.jdxs,tpxo.idxs),model.lon,model.lat);
    ...
    zeta = nc_varget(['./',model.file_prefix,'his2',model.file_suffix,'_zeta.nc'],'zeta');
    ...
    ubar = nc_varget(['./',model.file_prefix,'his2',model.file_suffix,'_ubar.nc'],'ubar');
    model.ubar = ubar(:,1:hskip:end,1:hskip:end);
    clear ubar
    vbar = nc_varget(['./',model.file_prefix,'his2',model.file_suffix,'_vbar.nc'],'vbar');
...
%% Harper's figure of merit
    ...
    num=(model.amp_ubar - tpxo.amp_ubar_BB).^2 .*model.dA_u.*model.mask_u;
    den=model.dA_u.*model.mask_u;
    model.D_u = sqrt( nansum(num(:))/nansum(den(:)) )
    
    num=(model.amp_vbar - tpxo.amp_vbar_BB).^2 .*model.dA_v.*model.mask_v;
    den=model.dA_v.*model.mask_v;
