...
/***!!!!!!  you have to define this in COASWST world or it won't include ROMS !!!!!*/
...
# define AGE_MEAN          /* define this flag if you want to track the age of a dye */
#endif
...
# define LMD_MIXING     /* jgp switch to GLS  */
# ifdef LMD_MIXING
#  define LMD_RIMIX
#  define LMD_CONVEC
#  define LMD_SKPP
...
# undef GLS_MIXING      /* jgp switch to GLS */
# undef MY25_MIXING
