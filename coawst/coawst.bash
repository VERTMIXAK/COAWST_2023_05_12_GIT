...
export NETCDF_LIBDIR=/usr/local/pkg/netcdf/netcdf-4.3.0.intel-2016/lib
...
localDir=`pwd`
export MCT_LIBDIR=$localDir/MCT/lib
export MCT_INCDIR=$localDir/MCT/include
...
export   COAWST_APPLICATION=PALAU_800m
...
export   MY_ROOT_DIR=/import/c1/VERTMIX/jgpender/coawst
export   MY_PROJECT_DIR=${MY_ROOT_DIR}/${COAWST_APPLICATION}
...
echo "COAWST_APPLICATION" $COAWST_APPLICATION
echo "ROMS_APPLICATION" $ROMS_APPLICATION
...
#    list the name here.  You need to have COAWST listed in the switch file.
 export  WW3_SWITCH_FILE=jgp_switch_NISKINE
...
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -D'DEBUGGING"
#
...
#   export     MY_HEADER_DIR=${MY_PROJECT_DIR}/InputFiles/compileInput
#   export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/InputFiles/compileInput
   export     MY_HEADER_DIR=${MY_ROOT_DIR}/Apps/$COAWST_APPLICATION/
   export MY_ANALYTICAL_DIR=${MY_ROOT_DIR}/Apps/$COAWST_APPLICATION/

echo "MY_HEADER_DIR" $MY_HEADER_DIR
echo "MY_ANALYTICAL_DIR" $MY_ANALYTICAL_DIR
